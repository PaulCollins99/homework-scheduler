        ...
        9: [function (_dereq_, module, exports) {
            ...
            var Task = Base.extend({
                initialize: function (params) {
                    ...
                    this.info = {
                        event_type: new SimpleReactiveVar(params.event_type),
                ...
                toJsonObj: function () {
                    return {
                        ...
                        event_type: this.info.event_type.get(),
                ...
                fromJsonObj: function (jsonObj) {
                    ...
                    this.info.event_type.set(jsonObj.event_type);
        ...
        10: [function (_dereq_, module, exports) {
            var TimeRangeValidator = {
                validate: function (newTimeRange, tasks) {
                    if (newTimeRange.start_time.toString() === "Invalid date" || newTimeRange.end_time.toString() === "Invalid date") return new this.ValidationError(this.ValidationError.TYPES.INVALIDATE, newTimeRange);
                    if (newTimeRange.start_time.toString() === newTimeRange.end_time.toString()) return new this.ValidationError(this.ERROR_TYPES.DUPLICATED, newTimeRange);
                    if (newTimeRange.start_time > newTimeRange.end_time) return new this.ValidationError(this.ERROR_TYPES.LATER_START, newTimeRange);
                    var timeRange;
                    for (var i in tasks) {
                        timeRange = tasks[i].timeRange;
                        var trKeys = ["start_time", "end_time"];
                        for (var j in trKeys) {
                            var trKey = trKeys[j];
                ...
                ERROR_TYPES: {
                    DUPLICATED: {
                        message: "Duplicated time range"
                    },
                    FOLDED: {
                        message: "partely duplicated time range"
                    },
                    LATER_START: {
                        message: "start time can not be later then end time"
                    },
                    INVALIDATE: {
                        message: "invalidate data type to convert momentjs obj"
                    }
                },
            ...
            var TimeTable = Base.extend({
                initialize: function (options) {
                    ...
                    this.rangeBar = RangeBar({
                        ...
                        snap: 1e3 * 60 * 15,
                        minSize: options.minSize || 1e3 * 60 * 15,
                    ...
                    this.rangeBar.on("change", function (ev, a, b, rangeObj) {
                        ...
                        if (task) self.$el.trigger("change.task", [task, self])
                    });
                ...
                setOnTimeChangeFunc: function (task) {
                    ...
                    var onTimeChange = function () {
                        var rangeNum = [self.rangeBar.abnormalise(task.timeRange.start_time.get()), self.rangeBar.abnormalise(task.timeRange.end_time.get())];
                ...
                addTask: function (params) {
                    ...
                    var rangeVal = [this.rangeBar.abnormalise(task.timeRange.start_time.get()), this.rangeBar.abnormalise(task.timeRange.end_time.get())];
