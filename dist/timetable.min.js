        ...
        10: [function (_dereq_, module, exports) {
            var TimeRangeValidator = {
                validate: function (newTimeRange, tasks) {
                    if (newTimeRange.work_start.toString() === "Invalid date" || newTimeRange.work_end.toString() === "Invalid date") return new this.ValidationError(this.ValidationError.TYPES.INVALIDATE, newTimeRange);
                    if (newTimeRange.work_start.toString() === newTimeRange.work_end.toString()) return new this.ValidationError(this.ERROR_TYPES.DUPLICATED, newTimeRange);
                    if (newTimeRange.work_start > newTimeRange.work_end) return new this.ValidationError(this.ERROR_TYPES.LATER_START, newTimeRange);
                    var timeRange;
                    for (var i in tasks) {
            ...
            var TimeTable = Base.extend({
                ...
                setOnTimeChangeFunc: function (task) {
                    ...
                    var onTimeChange = function () {
                        var rangeNum = [self.rangeBar.abnormalise(task.timeRange.work_start.get()), self.rangeBar.abnormalise(task.timeRange.work_end.get())];
                ...
                addTask: function (params) {
                    ...
                    var rangeVal = [this.rangeBar.abnormalise(task.timeRange.work_start.get()), this.rangeBar.abnormalise(task.timeRange.work_end.get())];
